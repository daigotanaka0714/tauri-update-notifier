...
describe('checkForUpdates', () => {
  ...
  it('should return update info when update is available', async () => {
    ...
    expect(result.releaseUrl).toBe('https://github.com/test/repo/releases/tag/v2.0.0');
  });
    ...
    mockFetch.mockResolvedValue({
      ...
      json: async () => ({
        ...
        assets: [
          {
            name: 'app-2.0.0.dmg',
            browser_download_url: 'https://github.com/test/repo/releases/download/v2.0.0/app-2.0.0.dmg',
            size: 12345678,
