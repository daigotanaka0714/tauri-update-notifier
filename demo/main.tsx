...
// Demo component that shows the notification
function DemoNotification({ position }: { position: 'bottom-right' | 'bottom-left' | 'top-right' | 'top-left' }) {
  ...
  return (
    <UpdateNotification
      ...
      checkOnMount={false}
      position={position}
      render={({ updateInfo, onDismiss, onSkipVersion }) => (
        <DemoCard
          updateInfo={mockUpdateInfo}
          onDismiss={() => setVisible(false)}
          onSkipVersion={() => setVisible(false)}
          position={position}
        />
      )}
    />
...
function App() {
  return (
    <div className="demo-container">
      ...
      <p className="subtitle">A lightweight update notification library for Tauri applications</p>
      ...
      <div className="mock-app" data-testid="mock-app">
        ...
        <div className="mock-content">
          <div className="mock-card">
            <h3>Dashboard</h3>
            <p>Welcome to your application. This is a mock app interface to demonstrate the update notification.</p>
          </div>
          <div className="mock-card">
